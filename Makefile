...
start-docker-test: stop-docker-test
	...
	@docker run --name bdjuno-test-db -e POSTGRES_USER=${POSTGRES_USER} -e POSTGRES_PASSWORD=${POSTGRES_PASSWORD} -e POSTGRES_DB=${POSTGRES_DB_TEST} -d -p 6433:5432 postgres
